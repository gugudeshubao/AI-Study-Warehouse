...
|---|---:|---:|---|
| `B2 H16 N128 D64` | `11.030` | `0.995` | `V3_CUDA` |
| `B2 H16 N256 D64` | `25.866` | `3.813` | `V3_CUDA` |
| `B2 H16 N512 D64` | `67.442` | `14.164` | `V3_CUDA` |
...
|---|---:|---:|---:|
| `B2 H16 N128 D64` | `1.254` | `0.093` | `13.49x` |
| `B2 H16 N256 D64` | `4.028` | `0.085` | `47.33x` |
| `B2 H16 N512 D64` | `14.306` | `0.127` | `113.08x` |
